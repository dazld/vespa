...
public class FS4InvokerFactory extends InvokerFactory {
    ...
    public SearchInvoker createSearchInvoker(Query query, Node node, VespaBackEndSearcher searcher) {
     ...
     */
    @Override
    public Optional<SearchInvoker> createSearchInvoker(Query query, VespaBackEndSearcher searcher, OptionalInt groupId, List<Node> nodes,
    ...
    public FillInvoker createFillInvoker(Result result, Node node, VespaBackEndSearcher searcher) {
     ...
     */
    public Optional<FillInvoker> createFillInvoker(Result result, VespaBackEndSearcher searcher) {
        ...
        for (Integer distKey : requiredNodes) {
            ...
            invokers.put(distKey, createFillInvoker(result, node, searcher));
        }
